<div align="center">
  <img src="assets/logo.png" alt="Scanly Logo" width="120" style="border-radius: 24%; box-shadow: 0 4px 15px rgba(22, 163, 74, 0.3); border: 4px solid #16a34a; object-fit: cover;" />
  ...
  [![Android SDK](https://img.shields.io/badge/Platform-Android%20%7C%20Web-green?style=for-the-badge&logo=android)](https://github.com/rahulloyal/Scanly)
  [![License](https://img.shields.io/badge/License-MIT-emerald?style=for-the-badge)](LICENSE)
  [![Release](https://img.shields.io/badge/Version-v1.0.0-teal?style=for-the-badge)](https://github.com/rahulloyal/Scanly/releases)
...
<div align="center">
  <a href="https://github.com/rahulloyal/Scanly/releases">
    <img src="https://img.shields.io/badge/View_Releases_&_Downloads-Go%20to%20Releases-green?style=for-the-badge&logo=github&logoColor=white&color=16a34a" alt="View Releases" />
  </a>
  
  <h3>OR</h3>

  <a href="https://github.com/rahulloyal/Scanly/releases/download/v1.0.0/Scanly.apk">
  ...
  <table style="border: none; border-collapse: collapse; width: 100%; max-width: 600px;">
    <tr>
      <td style="padding: 10px; border: none; text-align: center; width: 50%;">
        <p><strong>Main Interface (Single URL)</strong></p>
        <img src="assets/Screenshot_20260528-075002.png" alt="Scanly Home" width="220" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); border: 1px solid #e5e7eb;" />
      </td>
      <td style="padding: 10px; border: none; text-align: center; width: 50%;">
        <p><strong>Batch QR Code Generator</strong></p>
        <img src="assets/Screenshot_20260528-075018.png" alt="Batch Processing" width="220" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); border: 1px solid #e5e7eb;" />
      </td>
    </tr>
    <tr>
      <td style="padding: 10px; border: none; text-align: center; width: 50%;">
        <p><strong>Generated QR Code Output</strong></p>
        <img src="assets/Screenshot_20260528-075037.png" alt="QR Code Output" width="220" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); border: 1px solid #e5e7eb;" />
      </td>
      <td style="padding: 10px; border: none; text-align: center; width: 50%;">
        <p><strong>Usage & Guide Information</strong></p>
        <img src="assets/Screenshot_20260528-075008.png" alt="Usage Cases" width="220" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); border: 1px solid #e5e7eb;" />
      </td>
    </tr>
  </table>
</div>
